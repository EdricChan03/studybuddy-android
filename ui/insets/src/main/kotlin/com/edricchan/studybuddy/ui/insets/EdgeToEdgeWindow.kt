 ...
 */
@file:JvmName("EdgeToEdgeWindow")

package com.edricchan.studybuddy.ui.insets
...
@JvmName("enable")
@JvmOverloads
// MODIFIED: Use Window instead of ComponentActivity
fun Window.enableEdgeToEdge(
    ...
    impl.setUp(
        statusBarStyle, navigationBarStyle, this, view, statusBarIsDark, navigationBarIsDark
    )
}
