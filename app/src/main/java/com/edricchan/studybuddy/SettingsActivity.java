...
//import com.takisoft.fix.support.v7.preference.;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GenericPreferenceFragment extends PreferenceFragmentCompat {
        private int preferenceResourceId;
        ...
        /**
         * Sets the preference resource XML
         *
         * @param preferencesResource The preference resource id in the form `R.xml.pref_resource`
         */
        public void setPreferencesResource(int preferencesResource) {
            preferenceResourceId = preferencesResource;
        }
    ...
    public static class TodosPreferenceFragment extends GenericPreferenceFragment {
        ...
        @Override
        public void setPreferencesResource(int preferencesResource) {
            super.setPreferencesResource(R.xml.pref_todos);
        }
...
//			addPreferencesFromResource(R.xml.pref_todos);
            TimePickerPreference preference = (TimePickerPreference) findPreference("weekly_summary_time");
...
//			addPreferencesFromResource(R.xml.pref_experimental);
        ...
        @Override
        public void setPreferencesResource(int preferencesResource) {
            super.setPreferencesResource(R.xml.pref_experimental);
        }
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class NotificationPreferenceFragment extends GenericPreferenceFragment {
        ...
        /**
         * Dynamically generates preferences when the client's Android API level is 26 or higher.
         */
        ...
        /**
         * Dynamically generates preferences for when the client's Android device is running Nougat (25) or lower
         */
        ...
        @Override
        public void setPreferencesResource(int preferencesResource) {
            super.setPreferencesResource(R.xml.pref_notification);
        }
...
//					}
    ...
    public static class DataSyncPreferenceFragment extends GenericPreferenceFragment {
        @Override
        public void setPreferencesResource(int preferencesResource) {
            super.setPreferencesResource(R.xml.pref_data_sync);
        }
...
//            addPreferencesFromResource(R.xml.pref_data_sync);
    ...
    public static class VersionPreferenceFragment extends GenericPreferenceFragment {
        @Override
        public void setPreferencesResource(int preferencesResource) {
            super.setPreferencesResource(R.xml.pref_versions);
        }
