...
class ShortcutUtils(
	...
	fun createPinnedShortcut(id: String, requestCode: Int,
		...
		if (ShortcutManagerCompat.isRequestPinShortcutSupported(context)) {
			...
			val pinnedShortcutCallbackIntent = ShortcutManagerCompat.createShortcutResultIntent(context,
					pinShortcutInfo)

			val successCallback = PendingIntent.getBroadcast(context, requestCode,
