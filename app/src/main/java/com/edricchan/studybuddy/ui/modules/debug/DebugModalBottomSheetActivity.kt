...
class DebugModalBottomSheetActivity :
    AppCompatActivity(R.layout.activity_debug_modal_bottom_sheet) {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        val modalBottomSheetLaunchersLayout =
            findViewById<LinearLayout>(R.id.modal_bottom_sheet_launcher_buttons_layout)
