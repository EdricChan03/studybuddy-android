...
class AboutFragment : MaterialAboutFragment() {
	...
	override fun getMaterialAboutList(context: Context?): MaterialAboutList {
		...
		val appInfoCard = MaterialAboutCard.Builder()
						...
						.setOnClickAction {
							...
							if (devHitCountdown > 0) {
								...
								if (devHitCountdown == 0) {
									...
									MaterialAlertDialogBuilder(context).apply {
										...
										setNegativeButton(R.string.dialog_action_disable) { dialog, _ ->
											devModeOptions.edit {
												...
												Toast.makeText(context, R.string.dev_mode_disabled, Toast.LENGTH_SHORT)
														.show()
											}
											dialog.dismiss()
										}
									...
									Toast.makeText(context, requireContext().resources.getQuantityString(
											R.plurals.dev_mode_countdown, devHitCountdown,
											devHitCountdown), Toast.LENGTH_SHORT).show()
								}
				...
				.addItem(MaterialAboutActionItem.Builder()
						...
						.build())
				.addItem(createWebsiteActionItem(Constants.uriSrcCode,
						R.string.about_frag_app_info_card_view_source_code_title,
						R.string.about_frag_app_info_card_view_source_code_subtitle, R.drawable.ic_code_24dp))
				.addItem(MaterialAboutActionItem.Builder()
		...
		val aboutAuthorCard = MaterialAboutCard.Builder()
				...
				.addItem(MaterialAboutActionItem.Builder()
						...
						.build())
				.addItem(createWebsiteActionItem(Constants.uriAuthorWebsite,
	...
	private fun createWebsiteActionItem(websiteUri: Uri, @StringRes textRes: Int,
		...
		return MaterialAboutActionItem.Builder()
				...
				.setOnClickAction {
					SharedUtils.launchUri(requireContext(), websiteUri)
				}
				.build()
	}

	private fun initFragment() {
		devModeOptions = requireContext().getSharedPreferences(DevModePrefConstants.FILE_DEV_MODE,
