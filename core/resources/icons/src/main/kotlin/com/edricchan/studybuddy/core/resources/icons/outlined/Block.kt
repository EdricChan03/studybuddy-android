...
/**
 * Outlined `block` icon from the
 * [Material Symbols icon font](https://fonts.google.com/icons?selected=Material+Symbols+Outlined:block:FILL@0;wght@400;GRAD@0;opsz@24).
 */
val AppIcons.Outlined.Block: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.Block",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
