...
/**
 * Outlined `calendar_clock` icon from the
 * [Material Symbols icon font](https://fonts.google.com/icons?selected=Material+Symbols+Outlined:calendar_clock:FILL@0;wght@400;GRAD@0;opsz@24).
 */
