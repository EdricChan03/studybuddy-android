...
/**
 * Outlined `settings` icon from the
 * [Material Symbols icon font](https://fonts.google.com/icons?selected=Material+Symbols+Outlined:settings:FILL@0;wght@400;GRAD@0;opsz@24&icon.query=settings&icon.size=24&icon.color=%23e3e3e3)
 */
val AppIcons.Outlined.Settings: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
